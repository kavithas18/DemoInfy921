...
Browser("Advantage Shopping").Page("Advantage Shopping").WebEdit("quantity").Set DataTable("p_Text", dtGlobalSheet)
...
Browser("Advantage Shopping").CloseAllTabs @@ hightlight id_;_67662_;_script infofile_;_ZIP::ssf8.xml_;_
